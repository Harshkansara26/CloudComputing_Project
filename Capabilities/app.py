...
#####
storage_location = 'aws-ai-301169854'
...
@app.route('/get_contact', methods = ['POST'], cors = True)
def get_contact_by_name():
    """gets all saved contacts in the contact store service"""
    request_data = json.loads(app.current_request.raw_body)
    contact_name = request_data['con_name']
    print("contact name:", contact_name)
    contact = contact_store.get_contact_by_name(contact_name)
